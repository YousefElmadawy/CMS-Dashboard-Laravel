...
<div class="row mt-3">
    <div class="col-md-8" >
        <h3 class="text-center mb-3 text-primary ">All Trashed Categories</h3>
        @if (session('success'))
           ...
           <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a href="{{ route('categories.hardDelete', ['id'=>$category->id])}}" class="btn btn-danger">Delete</a>
                    </td>
        ...
        <div>{{ $trashedcategories->links() }}</div>
